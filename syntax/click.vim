...
if exists("c_comment_strings")
  ...
  syn region	cComment2L	start="#" skip="\\$" end="$" keepend contains=@cCommentGroup,cSpaceError,@Spell
  if exists("c_no_comment_fold")
...
" cfg file instructions:
syn keyword     cStorageClass   PARAMETER BIND DEVICE_NAME DEVICE_SUBNET_NAME_INFO DEVICE_GW_NAME_INFO VIRTUAL_DEVICE_NAME VIRTUAL_DEVICE_IP6_SUBNET ANYCAST_DEVICE
syn keyword     cStorageClass   VIRTUAL_DEVICE_IP4_SUBNET VIRTUAL_DEVICE_IP6_SUBNET VIRTUAL_DEVICE_SUBNET_NAME_INFO VIRTUAL_DEVICE_GW_NAME_INFO IP6_FIREWALL_RULE

" Our own elements:
syn keyword     cStorageClass   DynARPQuerier DynARPResponder DynICMP6Error DynICMPError DynIP6NDAdvertiser802154 DynIP6NDAdvertiser 
syn keyword     cStorageClass   DynIP6NDSolicitor DynIPGWOptions DynIPv4Routing DynIPv6Routing DynRedirectDetection DynSetMacAnnoIn 
syn keyword     cStorageClass   DynVirtualDeviceClassifier EventManager GlobeConf InterfaceClassifier InterfaceManager IP6MulticastClassifier 
syn keyword     cStorageClass   SuperDev SuperFromDevice SuperToDevice cJSON ClickToSensor ClickToSensorRadio COAPClientFrontend COAPClientServer 
syn keyword     cStorageClass   COAPCOAPProxy COAPCrawler COAPDiscoveryToResourceDirectory COAPDummySensorClassifier coapHelper COAPInternalClient 
syn keyword     cStorageClass   COAPMirrorServerSensorsBackend coapProfiles coapProtocol coapResources COAPServerDiscovery COAPServerGenericBackend 
syn keyword     cStorageClass   COAPServerModule COAPServerModuleComacod COAPServerModuleComacodIPSO COAPServerModuleDiscovery COAPServerModuleDTM 
syn keyword     cStorageClass   COAPServerModuleDummySensors COAPServerModuleEntities COAPServerModuleMirrorServer COAPServerModulePlugtest1 
syn keyword     cStorageClass   COAPServerModulePlugtest2 COAPServerModuleResourceDirectory COAPServerModuleTestbed COAPServerModuleTestbedCoREInterfaces 
syn keyword     cStorageClass   COAPSmartServiceProxy COAPToSensor COAPTrafficClassifier DSCP DSCPClient framer802154 HTTPCOAPProxy HTTPCOAPTransparentProxyTun 
syn keyword     cStorageClass   IEEE802154AddressingManager intervaltree LoWPANAdaptationLayer lowpanizer md5_impl PervayaParser RandomDelay 
syn keyword     cStorageClass   SensorGatewayTun VirtualCOAPAdapter VirtualCOAPCacheAdapter VirtualCOAPCongestionAdapter VirtualCOAPContentTypeAdapter 
syn keyword     cStorageClass   VirtualCOAPCoreAdapter VirtualCOAPIntercept VirtualCOAPManagementModule VirtualCOAPProxyAdapter VirtualCOAPServerBackend VirtualCOAPStaticAdapter

" Match element named in front of ::
syn match       cElementName    "\w*\s\=::"
hi def link cElementName		Keyword
...
hi def link cComment2L		cComment
